...
//        unsubscribe(nullptr,topic.c_str());
        loop_start();
    }
...
int main()
{
    ...
    std::cout<<"Major-Minor-Revision = "<<major<<"\t"<<minor<<"\t"<<revision<<std::endl;

    MqttClientTest client("id_send","Books");
    for(int i=0;i<100000;i++)
    {
        client.sendMessage("I am King! "+std::to_string(i));
